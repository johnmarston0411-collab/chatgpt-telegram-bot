...
| `ALLOWED_TELEGRAM_USER_IDS` | A comma-separated list of Telegram user IDs that are allowed to interact with the bot (use [ShowUserIDBot](https://t.me/ShowUserIDBot) to find your user ID). **Note**: by default, *everyone* is allowed (`*`)                       |
